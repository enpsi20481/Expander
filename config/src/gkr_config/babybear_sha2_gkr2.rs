...
use babybear::{BabyBear, BabyBearExt4, BabyBearExt4x16, BabyBearx16};

use super::{FiatShamirHashType, FieldType, GKRConfig};

#[derive(Debug, Clone, PartialEq, Default)]
pub struct BabyBearExt4ConfigSha2Gkr2;

impl GKRConfig for BabyBearExt4ConfigSha2Gkr2 {
    ...
    fn field_mul_circuit_field(a: &Self::Field, b: &Self::CircuitField) -> Self::Field {
        // directly multiply BabyBearExt4 with BabyBear
        // skipping the conversion BabyBear -> BabyBearExt4
        *a * *b
    }

    #[inline(always)]
    fn field_add_circuit_field(a: &Self::Field, b: &Self::CircuitField) -> Self::Field {
        // directly add BabyBearExt4 with BabyBear
        // skipping the conversion BabyBear -> BabyBearExt4
        *a + *b
    }
